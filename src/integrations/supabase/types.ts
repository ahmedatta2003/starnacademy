  ...
  public: {
    Tables: {
      ...
      student_courses: {
        ...
        Relationships: [
          {
            foreignKeyName: "student_courses_instructor_id_fkey"
      ...
      student_achievements: {
        Row: {
          id: string
          student_id: string
          achievement_type: "star" | "project" | "milestone"
          title: string
        ...
        Relationships: [
          {
            foreignKeyName: "student_achievements_related_course_id_fkey"
      ...
      student_feedback: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "student_feedback_instructor_id_fkey"
            columns: ["instructor_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
